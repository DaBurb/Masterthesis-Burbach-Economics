...
Analyses are based mainly on Eurostat FIGARO data, accompanied by **World Input Output Database (WIOD) (price data)**, more accurately its complementary dataset called **Socioeconomic Accounts (SEA)**, and **EXIOBASE3** (disaggregation of natural gas extraction and mining and quarrying sector).
...
- **Louvain Community Detection:**  
  Applies community detection to the endogenous impact matrix (before CPI-weighting) to identify clusters of countries or sectors that are more connected in the price system. 
...
- **NOTE**
It is divided into including domestic and excluding domestic gas extraction sectors. The focus in the thesis lies on imports, so the domestic sector is excluded in the main analysis. However, the domestic sector is included in the visualizations.
