...
- **Louvain Community Detection:**  
  Applies community detection to the endogenous impact matrix (before CPI-weighting) to identify clusters of sectors that contribute similarly to inflation. 
